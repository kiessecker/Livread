...
function validateLogin() {
	...
	document.getElementById("validated").value=document.getElementById("txtMail").value;
...
<tr>
<td colspan="3"><h1><?php echo UNIQUEAPPNAME;?> Registrierung<h1></td>
</tr>
<tr>
...
<td><input name="txtUsername" 
		...
		promptMessage="Bitte gib einen beliebigen Benutzernamen ein,<br /> mit dem Du dich später anmelden möchtest.<br />Der Benutzername muß sollte 5-30 Zeichen lang sein<br />und darf nur aus Buchstaben und Ziffern bestehen." /></td>
<td width="250">
</td>
</tr>
<tr>
...
<td>
<input name="txtPassword1" type="password" id="txtPassword1" value="" required="true" dojoType="dijit.form.ValidationTextBox" promptMessage="Bitte gib ein beliebiges Passwort ein,<br />mit dem Du dich später anmelden möchtest.<br />Mindestens 4 Zeichen." />
</td>
<td width="250">
</td>
</tr>
...
<td width="150">&nbsp;</td>
<td colspan="2">
<input name="validated" type="text" id="validated" value="" required="true" dojoType="dijit.form.ValidationTextBox" regExpGen="dojox.validate.regexp.emailAddress" trim="true" style="visibility:hidden" />

 <button dojoType="dijit.form.Button" type="submit" name="btnLogin"
            value="Submit" onClick="validateLogin();">
