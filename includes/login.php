...
<table id="loginTableArea" width="100%" border="0" cellpadding="5" cellspacing="5">
<tr>
...
<tr>
<td colspan="2"><div style="margin-top:10px">Du hast noch kein Konto? <small><nobr>&#9655; &#9655; &#9655;</nobr></small> <a href="index.application.php?applicationAction=register&register=true">Registrieren</a></div></td>
</tr>
</table>
</div>
...
*/
	...
	tp = new parent.dijit.TitlePane({
	    title: "Demo-Modus",
	    content: "<div id='MyLeftPaneInfoDemo'>Du kannst Livread testen, wähle dazu unter <em>Datei</em> &#9654; <em>Buch öffnen ...</em> ein Buch, das Du lesen möchtest ...</div>"
	});
	parent.document.getElementById("paneLeftInfoPane").appendChild(tp.domNode);
//	parent.document.getElementById("paneLeftInfoPane").appendChild(separatorElement);
	tp = new parent.dijit.TitlePane({
	    title: "Quickie Demo",
	    content: "<div id='MyLeftPaneInfoDemo'><strong>Integrativer Reader:</strong> <a href='index.application.php?applicationAction=read&updateApplicationMenu=true&book=113' target='PAPERFRAME'>Siddhartha &mdash; Hermann Hesse</a> ... <br/><strong>Standalone Reader:</strong> <span style='font-size:75%'>Hinweis: klicke auf den rechten/linken Blattbereich, um zu blättern</span><br /><a href='ebook.php?book=85' target='_top'>Bram Stokers Dracula (englisch)</a></div>"
	});
	parent.document.getElementById("paneLeftInfoPane").appendChild(tp.domNode);
